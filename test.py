...
def test_rates_MO_3():
    rate_finder = RateFinder('zips.csv', 'plans.csv')
    eq_(sorted(rate_finder.rates[('MO', '3')]), [234.6, 245.2, 251.08, 253.65, 265.25, 265.82, 271.64, 290.05, 298.87, 312.06, 319.57, 341.24, 351.6])
...
def test_rates_IN_3():
    rate_finder = RateFinder('zips.csv', 'plans.csv')
    eq_(sorted(rate_finder.rates[('IN', '3')])[:3], [277.56, 282.43, 289.6])
    
def test_rates_IN_4():
    rate_finder = RateFinder('zips.csv', 'plans.csv')
    eq_(sorted(rate_finder.rates[('IN', '4')])[:3], [268.1, 272.81, 279.73])
